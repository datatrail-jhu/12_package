...
{choose-answers: 4} 
? Why spend time writing vignettes?

C) They're long-form documentation that helps explain and demonstrate through text and code how to use your package.
o) They store unit tests which demonstrate that your package works correctly.
o) They allow you to document each functions inputs and outputs using roxygen. 
o) They provide a space where using code alone you can explain your package.
o) They provide a space where using text alone you can explain your package.
o) They're long-form documentation that helps explain and demonstrate through text alone how to use your package.
o) They're long-form documentation that helps explain and demonstrate through code alone how to use your package.

{choose-answers: 4} 
? Who is your target audience when writing vignettes?

C) Beginners
o) Yourself
o) Intermediate programmers
o) Advanced programmers
o) People familiar with your work
o) Other developers you worked with on the package development

{choose-answers: 4} 
? Why didn't we use Clean & Rebuild from the Build tab in this lesson?

C) Clean & Rebuild skips building vignettes to save time.
o) Clean & Rebuild builds vignettes incorrectly.
o) Clean & Rebuild only builds vignettes and not the package 
o) Clean & Rebuild will error out if vignettes are in your package.
o) Clean & Rebuild does not know how to work with the `devtools` package.

{choose-answers: 4} 
? Which of the following is TRUE about package vignettes?

C) Vignettes use text and code to demonstrate functionality
o) Each package should have one and only one vignette.
o) Vignettes are the only form of documentation in R packages.
o) Vignettes are the appropriate place to store package function code.
o) Vignettes document individual functions.
o) Vignettes are the appropriate place to store package data.
